'use strict'; var Ajaxinate = function ajaxinateConstructor(config) { var settings = config || {}; var defaultSettings = { pagination: '.AjaxinatePagination', method: 'scroll', container: '.AjaxinateLoop', offset: 0, loadingText: 'Loading', callback: null, orientation: '#product-loop' }; 
...
Ajaxinate.prototype.addClickListener = function addEventListenerForClicking() { 
    if (this.paginationElement) { 
        ...
        this.clickActive = true; if (this.nextPageLinkElement !== null) { 
...
Ajaxinate.prototype.stopMultipleClicks = function handleClickEvent(event) { 
    ...
    if (this.clickActive) { 
        ...
        if (this.nextPageLinkElement) {
            ...
            this.clickActive = false; this.loadMore();
        } 
    } 
}; 
...
Ajaxinate.prototype.loadMore = function getTheHtmlOfTheNextPageWithAnAjaxRequest() {
    ...
    this.request.onreadystatechange = function success() {
        if (this.request.readyState === 4 && this.request.status === 200) {
            ...
            var newPagination = this.request.responseXML.querySelectorAll('#pagination')[0]; 
