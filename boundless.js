...
function handlertag() {
    try{
        ...
        lazyscript.src = "https://cdn.jsdelivr.net/gh/ashishm1/infyload@main/ajaxinate-boundless.js";
    }
    catch(err){
        console.log(err);
    }
...
function addAjax(){
    ...
    if (ll > 0) {
        ...
        pageElement = $('.pagination--infinite')[0]
        pageElement.setAttribute("id", "LazyLoader-Pagination")
        $('div.collection-grid').attr("id", "LazyLoader-Loop")
    }
