...
function handlertag() {
    try{
        ...
        lazyscript.src = "https://cdn.jsdelivr.net/gh/ashishm1/infyload@main/ajaxinate-envy.js";
    }
    catch(err){
        console.log(err);
    }
...
function addAjax(){
    ...
    var productgrid = $('.row.product-grid.clearfix')
    if(productgrid.length > 0) {
        var pgrid = productgrid[0]
        pgrid.setAttribute("id", "LazyLoader-Loop");
        orientation = '.row.product-grid.clearfix';
        }
