...
function handlertag() {
    try{
        ...
        lazyscript.src = "https://cdn.jsdelivr.net/gh/ashishm1/infyload@main/ajaxinate-mobilia.js";
    }
    catch(err){
        console.log(err);
    }
...
function addAjax(){
    ...
    var productgrid = $('div.modal');
    if(productgrid.length > 0) {
        var pgrid = productgrid[0];
        pgrid.parentElement.setAttribute("id", "LazyLoader-Loop");
        var orientation = 'div.modal';
        }
